...
const ARQUIVO = join(DIR, 'progress-testes.json');
...
/**
 * Marca um módulo como concluído e soma o XP (uma única vez por módulo).
 * Devolve o progresso atualizado.
 */
export function concluirModulo(id: number, xp: number): Progresso {
